set_property PACKAGE_PIN AH4 [get_ports ddr4_odt]
set_property PACKAGE_PIN AE8 [get_ports ddr4_bg]
...
set_property PACKAGE_PIN AB6 [get_ports ddr4_cs_n]
set_property PACKAGE_PIN AG6 [get_ports ddr4_ck_t]
set_property PACKAGE_PIN AG5 [get_ports ddr4_ck_c]
set_property PACKAGE_PIN AE4 [get_ports ddr4_cke]
...
set_property PACKAGE_PIN AD5 [get_ports {ddr4_dm_dbi_n[1]}]
set_property PACKAGE_PIN AG4 [get_ports {ddr4_dm_dbi_n[0]}]